...
#	_ptr	500					[perturb_rate] in hma; _ptr*0.001; the proportion of jobs in the makespan machine needed to be swapped with jobs in other machine; default value: 50; [0,100]; In ECA, represents the ratio of greedy and random
...
#	_cl	5						[cl]; length of the chain
#	_am 1						[am]; algorithm methods; 0: iterated local search; 1: ejection chain local search; [0,1];
...
#	./pms_dc.out  _if instance//BB_Problem_BestSolution// _of results// _cx 1000 _ni1 2 _ni2 3 _vj2 2 _mj1 1 _mj2 2 _pi2 1 _di1 2 _ins1 14 _ins2 14
	./pmst.out _px pmst_ils _if instance//BB_Problem_BestSolution// _of results// _ptr 100 
