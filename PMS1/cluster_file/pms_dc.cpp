...
{
	for (int i = 0; i < (s[si][mm[si]].size()-1) * ptr_rate*0.001; i++)
	{
...
void run_algorithm(std::map<string, string> &argv_map, string ins_name)
{
	...
	pms->pu_beta = stoi(argv_map.at("_pu_beta"))*0.001;
...
int main(int argc, char **argv)
{
	char *rgv_ins[] = { "",
		...
		"_ws","0", "_t","50",
		"_cp","95", "_ns","0",
		"_non_popu","10","_cx","300",
		"_pu_beta","600", "_px","hma",
		"_dc","1", "_ls","3",
		"_pu","1",	"_xo","1",
	...
	char *rgv[] = { "",	//0
		...
		"_ptr","500",	// perturbation rate 
		"_rm","2",	// construction rules for initial solution
		...
		"_cx","300",	// crossover vs perturbation rate
		"_pu_beta","600",	//pool update coefficient
		"_dc", "1",	// whether use divide and conquer
		"_ls", "3",	// local search method
		"_pu", "1",	// pool update method
		"_xo", "1",	// crossover method
		"_vi1","1",		"_vi2","2",
		"_ni1","2",		"_ni2","3",
		"_vj1","0",		"_vj2","2",
		"_mj1","1",		"_mj2","2",
